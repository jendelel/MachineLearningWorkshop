...
plot(xy_rating_men, main="Average rating vs. IMDB rating by men", xlab="IMDB rating", ylab="Average rating", xlim=c(1, 10))
plot(xy_rating_women, main="Average rating vs. IMDB rating by women", xlab="IMDB rating", ylab="Average rating", xlim=c(1, 10))
...
# Interpretation: Ratings feature and age feature are independent. 
